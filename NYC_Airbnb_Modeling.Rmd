---
title: "NYC Airbnb Price Analysis - Predictive Modeling"
author: "Andres Perez"
output: 
  html_document:
    toc: true
...
This document focuses on the predictive modeling of Airbnb listing prices in New York City, building separate models for each borough and analyzing their performance.
...
1. **Model Complexity**: Different boroughs required different levels of model complexity:
   - Manhattan and Brooklyn: Separate models for shared/private bathrooms
   - Other boroughs: Simpler unified models

2. **Feature Importance**:
   - Accommodates and room type are consistently important
   - Bathroom type is crucial in Manhattan and Brooklyn
   - Location features vary in importance by borough

3. **Model Performance**:
   - Manhattan models show highest RMSE (most variable market)
   - Staten Island shows lowest RMSE (more stable market)
   - Brooklyn models show good balance of complexity and accuracy

4. **Prediction Accuracy**:
   - Better predictions for mid-range prices
   - Higher variance in luxury market predictions
   - More accurate in areas with more listings

# Recommendations

1. **For Price Prediction**:
   - Use borough-specific models
   - Consider bathroom type in Manhattan/Brooklyn
   - Include neighborhood-level features

2. **For Model Implementation**:
   - Regular retraining for market changes
   - Separate models for luxury listings
   - Borough-specific feature selection
